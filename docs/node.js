...
;
	($.$learn_testapp_logo_demo) = class $learn_testapp_logo_demo extends ($.$mol_example_small) {
		Logo(){
	...
	($mol_mem(($.$learn_testapp_logo_demo.prototype), "Logo"));
...
;
	($.$learn_testapp_button_demo) = class $learn_testapp_button_demo extends ($.$mol_example_small) {
		Login(){
	...
	($mol_mem(($.$learn_testapp_button_demo.prototype), "Login"));
	($mol_mem(($.$learn_testapp_button_demo.prototype), "Logout"));
...
;
	($.$learn_testapp_docs) = class $learn_testapp_docs extends ($.$mol_app_demo) {
		menu_title(){
			return "Демонстрации";
		}
		source_prefix(){
			return "https://github.com/learn/testapp/tree/master/";
		}
		sources_uri(){
			return "https://github.com/learn/testapp/";
		}
	};
