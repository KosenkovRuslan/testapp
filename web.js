...
;
	($.$learn_testapp_logo) = class $learn_testapp_logo extends ($.$mol_icon_molecule) {};
...
var $;
(function ($) {
    $mol_style_attach("learn/testapp/logo/logo.view.css", "[learn_testapp_logo] {\n\tanimation: rotate 4s infinite;\n}\n\n@keyframes rotate {\n\t0% {\n\t\ttransform: rotate(0deg)\n\t}\n\n\t100% {\n\t\ttransform: rotate(360deg)\n\t}\n}\n");
})($ || ($ = {}));
...
;
	($.$learn_testapp_button) = class $learn_testapp_button extends ($.$mol_button_major) {};
...
;
	($.$learn_testapp_app) = class $learn_testapp_app extends ($.$mol_book2_catalog) {
		Logo2(){
			const obj = new this.$.$learn_testapp_logo();
			return obj;
		}
		Theme(){
		...
		Sources(){
			...
			(obj.uri) = () => ("https://github.com/learn/testapp");
			return obj;
		}
		Lighter(){
		...
		Logout_button(){
			const obj = new this.$.$learn_testapp_button();
			(obj.title) = () => ("Выйти");
			return obj;
		}
		Docs_uri(){
			...
			(obj.uri) = () => ("http://localhost:9080/learn/testapp/docs/-/test.html");
			return obj;
		}
		Docs(){
			const obj = new this.$.$mol_page();
		...
		Hello(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("# Привет https://mol.hyoo.ru/#!section=docs/=6leyma_5ks814]\nИнструкция по шаблону читай на https://github.com/learn/testapp");
			return obj;
		}
		Page1(){
			const obj = new this.$.$mol_page();
	...
	($mol_mem(($.$learn_testapp_app.prototype), "Logo2"));
	($mol_mem(($.$learn_testapp_app.prototype), "Theme"));
	($mol_mem(($.$learn_testapp_app.prototype), "Sources"));
	($mol_mem(($.$learn_testapp_app.prototype), "Lighter"));
	($mol_mem(($.$learn_testapp_app.prototype), "Logout_button"));
	($mol_mem(($.$learn_testapp_app.prototype), "Docs_uri"));
	($mol_mem(($.$learn_testapp_app.prototype), "Docs"));
	($mol_mem(($.$learn_testapp_app.prototype), "Hello"));
	($mol_mem(($.$learn_testapp_app.prototype), "Page1"));
